...
WITH staging AS (
  ...
  SELECT
    CONCAT('purchase_order_detail|adventure_works|', purchase_order_detail_id, '~epoch|valid_from|', purchase_order_detail__valid_from)::BLOB AS _pit_hook__purchase_order_detail,
