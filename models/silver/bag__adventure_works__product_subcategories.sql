...
WITH staging AS (
  ...
  SELECT
    CONCAT('product_subcategory|adventure_works|', product_subcategory_id, '~epoch|valid_from|', product_subcategory__record_valid_from)::BLOB AS _pit_hook__product_subcategory,
