...
WITH bridge AS (
  ...
  LEFT JOIN silver.bag__adventure_works__products
    ON bag__adventure_works__sales_order_details._hook__product = bag__adventure_works__products._hook__product
    AND bag__adventure_works__sales_order_details.sales_order_detail__record_valid_from <= bag__adventure_works__products.product__record_valid_to
    AND bag__adventure_works__sales_order_details.sales_order_detail__record_valid_to >= bag__adventure_works__products.product__record_valid_from
